...
transPos=trans[trans[,"SeqWGS_CCND2_CALL"]>0, c("Study_Visit_ID","SeqWGS_CCND2_CALL")]
transNeg=trans[trans[,"SeqWGS_CCND2_CALL"]==0, c("Study_Visit_ID","SeqWGS_CCND2_CALL")]
...
write.table(res,file="SeqWGS_CCND2_CALL.tsv", append=FALSE, sep="\t", eol="\n", row.names=TRUE, col.names=TRUE)
