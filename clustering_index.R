...
get_chr_sizes = function() {
    temp = read.table("/ifs/work/leukgen/home/gg10/soft/ClusterSV/hg19.chrom_sizes", header = F, sep = "\t")
    chr_sizes = temp[,2]
...
centromere_telomere_coords = as.matrix(
    read.table(
        "/ifs/work/leukgen/home/gg10/soft/ClusterSV/hg19_centromere_and_telomere_coords.txt",
        header = T,
        sep = "\t",
        row.names = 1
    )
