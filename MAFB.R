...
transPos=trans[trans[,"SeqWGS_MAFB_CALL"]>0, c("Study_Visit_ID","SeqWGS_MAFB_CALL")]
transNeg=trans[trans[,"SeqWGS_MAFB_CALL"]==0, c("Study_Visit_ID","SeqWGS_MAFB_CALL")]
...
write.table(res,file="SeqWGS_MAFB_CALL.tsv", append=FALSE, sep="\t", eol="\n", row.names=TRUE, col.names=TRUE)
