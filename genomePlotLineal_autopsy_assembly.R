...
sv=paste0("/Users/yellapav/Desktop/p220_2019/genome_plots/input/",sample,"_brass_as.txt")
...
pdf(paste0("/Users/yellapav/Desktop/p220_2019/genome_plots/plots/",sample,"_genome_plot_as.pdf"), height=7, width=15)
...
# GLOBAL PROFILE:
layout(matrix(c(1,2),ncol=1), widths=c(7,7), heights=c(1,3), TRUE) 
