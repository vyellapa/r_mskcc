...
### Hotspot #####
ycts=getCts("/Users/yellapav/Desktop/record/RNA_TP53/hotspot.mat")
conds=c("WT","Hotspot","Hotspot","WT","Hotspot","Hotspot","WT","Hotspot","Hotspot","Hotspot","Hotspot","Hotspot","WT","WT","Hotspot","WT","WT","WT","WT","WT","WT")
c("Y","Y","N","Y","Y","Y","Y","Y","Y","Y","Y","N","Y","Y","Y","Y","Y","Y","Y","Y","Y")
yres=getResults(ycts, conds)
see=annotate(yres$res, ens_v75, "~/Desktop/TP53_take2/WT_vs_Hotspot.tsv")


#### MIssense ####
ycts=getCts("/Users/yellapav/Desktop/record/RNA_TP53/missense.mat")
...
yres=getResults(ycts, conds)
see=annotate(yres, ens_v75, "~/Desktop/TP53_take2/WT_vs_Missense.tsv")
...
yres=getResults(ycts, conds)
see=annotate(yres, ens_v75, "~/Desktop/TP53_take2/WT_vs_Truncating.tsv")
...
pheatmap(sampleDistMatrix, clustering_distance_rows=sampleDists, clustering_distance_cols=sampleDists, col=colors, annotation_col=as.data.frame(rownames(sampleDistMatrix)),main="L2 distance between samples")
