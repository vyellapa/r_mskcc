...
transPos=trans[trans[,"SeqWGS_MAFA_CALL"]>0, c("Study_Visit_ID","SeqWGS_MAFA_CALL")]
transNeg=trans[trans[,"SeqWGS_MAFA_CALL"]==0, c("Study_Visit_ID","SeqWGS_MAFA_CALL")]
...
write.table(res,file="SeqWGS_MAFA_CALL.tsv", append=FALSE, sep="\t", eol="\n", row.names=TRUE, col.names=TRUE)
