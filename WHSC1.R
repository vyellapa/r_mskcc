...
transPos=trans[trans[,"SeqWGS_WHSC1_CALL"]>0, c("Study_Visit_ID","SeqWGS_WHSC1_CALL")]
transNeg=trans[trans[,"SeqWGS_WHSC1_CALL"]==0, c("Study_Visit_ID","SeqWGS_WHSC1_CALL")]
...
write.table(res,file="SeqWGS_WHSC1_CALL.tsv", append=FALSE, sep="\t", eol="\n", row.names=TRUE, col.names=TRUE)
