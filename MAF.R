...
transPos=trans[trans[,"SeqWGS_MAF_CALL"]>0, c("Study_Visit_ID","SeqWGS_MAF_CALL")]
transNeg=trans[trans[,"SeqWGS_MAF_CALL"]==0, c("Study_Visit_ID","SeqWGS_MAF_CALL")]
...
write.table(res,file="SeqWGS_MAF_CALL.tsv", append=FALSE, sep="\t", eol="\n", row.names=TRUE, col.names=TRUE)
