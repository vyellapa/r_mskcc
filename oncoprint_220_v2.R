setwd("/Users/yellapav/Desktop/record/p220/post_process/mafs")
library(ComplexHeatmap)


mat=read.table("p220_oncoplot_v3.txt", header = TRUE, stringsAsFactors = F, sep="\t")
rownames(mat)=mat[,1]
mat=mat[,-1]
mat=as.matrix(mat)
...
alter_fun = list(
  ...
  In_Frame_Del = function(x, y, w, h) {
    grid.rect(x, y, w-unit(0.5, "mm"), h*0.5, gp = gpar(fill = "#EA3599", col = NA))
  }
...
col = c("Translocation" = "#f46d43", "Amp" = "#d73027", "Del" = "#4575b4", "Splice_Site"="#B8DC3C", "Missense_Mutation" = "#1a9850", "Frame_Shift_Del"="#a6cee3", "In_Frame_Del"="#EA3599" )
...
oncoPrint(mat, get_type = function(x) strsplit(x, ";")[[1]],
          ...
          heatmap_legend_param = list(title = "Alternations", at = c("Amp", "Del", "Translocation", "Splice_Site", "Missense_Mutation", "Frame_Shift_Del", "In_Frame_Del"), 
                                      labels = c("Amplification", "Deletion", "Translocation", "Splice Site", "Missense", "Frame Shift Del", "In-Frame Del")))
