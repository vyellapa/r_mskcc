...
col = c("SMOLDERING" = "#06A77D","PLASMA.CELL.LEUKEMIA"="#005377","MGUS"="#F1A208","MYELOMA"="#035d46","AMYLOIDOSIS"="#DC6941","Sequenced"="#A9A9A9" )
...
rorder=c('Sequenced','13q.loss','11q.gain','1q.gain','14q.loss','16q.loss','8p.loss','6q.loss','17p.loss','1p.loss','12p.loss','t(11;14)','t(4;14)','t(8;14)','t(6;14)','t(14;16)','t(14;20)','KRAS','NRAS','TP53','FAM46C','BRAF','DIS3','IRF4','LTB','PTPN11','RB1','SP140','BIRC3','TRAF3')                                               
...
ht = oncoPrint(mat, get_type = function(x) strsplit(x, ";")[[1]],
               ...
               column_title = "Alterations in all 154 Samples", show_column_names = FALSE, remove_empty_columns=FALSE, column_names_gp = gpar(fontsize = 4),row_names_gp = gpar(fontsize = 10),
  ...
  rowAnnotation(Proportion = row_anno_barplot(m, gp = gpar(fill = c("#DC6941","#F1A208","#035d46","#005377","#06A77D","#A9A9A9")), 
...
l=c("A",rep("CNA",10),rep("ASV",6),rep("SNV",13))
