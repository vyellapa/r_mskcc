...
transPos=trans[trans[,"SeqWGS_CCND3_CALL"]>0, c("Study_Visit_ID","SeqWGS_CCND3_CALL")]
transNeg=trans[trans[,"SeqWGS_CCND3_CALL"]==0, c("Study_Visit_ID","SeqWGS_CCND3_CALL")]
...
write.table(res,file="SeqWGS_CCND3_CALL.tsv", append=FALSE, sep="\t", eol="\n", row.names=TRUE, col.names=TRUE)
