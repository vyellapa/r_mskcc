...
i = "/work/isabl/home/yellapav/projects/polyA/bams/output/SRR3163585_IPAdepth.txt"
  print(i)
...
write.table(pval.df,"./SRR3163585_out.txt",col.names = F, row.names = F, append = F, quote = F, sep = "\t")
